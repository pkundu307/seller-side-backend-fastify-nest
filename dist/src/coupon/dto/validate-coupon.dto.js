...
__decorate([
    (0, swagger_1.ApiProperty)({ description: 'The coupon code to validate', example: 'WELCOME10' }),
...
__decorate([
    (0, swagger_1.ApiProperty)({ description: 'The current subtotal of the cart to check against minOrderAmount' }),
