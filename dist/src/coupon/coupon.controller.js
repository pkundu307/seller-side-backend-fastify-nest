...
__decorate([
    ...
    (0, swagger_1.ApiOperation)({ summary: 'Validate a coupon code (Public)' }),
    (0, swagger_1.ApiResponse)({ status: 201, description: 'Coupon is valid, returns discount details.' }),
    (0, swagger_1.ApiResponse)({ status: 400, description: 'Coupon is invalid (expired, not found, etc.).' }),
...
exports.CouponsController = CouponsController = __decorate([
    ...
    __metadata("design:paramtypes", [coupon_service_1.CouponsService])
], CouponsController);
